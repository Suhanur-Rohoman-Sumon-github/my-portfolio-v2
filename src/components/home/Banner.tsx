      ...
      <div className="hero-content md:flex items-center justify-center">
        ...
        >
          ...
          <p className="py-6 text-[#C6BDD0]">
            I am a passionate web developer with a focus on creating elegant and
            intuitive user experiences. Through my portfolio, I showcase my
            skills and projects, demonstrating my dedication to crafting
            exceptional websites. Join me on this journey as I explore the world
            of web development and bring creative ideas to life.
          </p>
        ...
        {/* Right Section: Image */}
        <div className="lg:w-1/3 w-full flex justify-center lg:justify-end mt-8 lg:mt-0 cards">
          <div className="cards">
            <Image
